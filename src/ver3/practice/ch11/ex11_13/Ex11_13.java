package ver3.practice.ch11.ex11_13;
// 다음 코드는 문제 11-12를 발전시킨 것으로,
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        TreeMap rank = new TreeMap(new Comparator(){
            public int compare(Object o1, Object o2) {
                ...
                (1) . 알맞은 코드를 넣어 완성하시오
                */
                // 1. 유효성 검사 - 형변환 가능 여부 확인
                // 2. 형변환
                // 3. 비교 결과 반환 - 점수 기준 내림차순
                if(o1 instanceof Player && o1 instanceof Player) {
                    int point1 = ((Player)o1).point;
                    int point2 = ((Player)o2).point;
